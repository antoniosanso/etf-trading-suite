...
| `.github/workflows/index-and-publish.yml` | 1,445 | `a61f9345` | [blob](https://github.com/antoniosanso/etf-trading-suite/blob/main/.github/workflows/index-and-publish.yml) | [raw](https://raw.githubusercontent.com/antoniosanso/etf-trading-suite/refs/heads/main/.github/workflows/index-and-publish.yml) |
...
| `docs/CONTENT_INDEX.md` | 3,841 | `c2e841d6` | [blob](https://github.com/antoniosanso/etf-trading-suite/blob/main/docs/CONTENT_INDEX.md) | [raw](https://raw.githubusercontent.com/antoniosanso/etf-trading-suite/refs/heads/main/docs/CONTENT_INDEX.md) |
...
### `.github/workflows/index-and-publish.yml`

```text
name: Index and Publish
...
concurrency:
  group: index-and-publish-${{ github.ref }}
